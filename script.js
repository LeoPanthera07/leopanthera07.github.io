...
const JOURNEY = [
  {
    ...
    desc: "The degree said Bioinformatics; the work was data science — complex biological systems, massive genomic datasets, and the daily discipline of pulling signal from noise. Earned a PG Research Fellowship along the way, and left Savitribai Phule Pune University with a research pipeline, an open-source tool adopted by 100+ scientists, and a conviction that the most interesting problems sit where biology, data, and software meet.",
    tags: ["Bioinformatics", "Data Science", "PG Research Fellowship"],
  },
  {
    year: "May – Jun 2024",
    cat: "Work",
